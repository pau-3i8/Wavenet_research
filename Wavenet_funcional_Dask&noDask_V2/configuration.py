from numba import float32, float64, types
...
- compression: Define el nivel (índice) de compresion del algoritmo gzip de los archivos hdf5 para la generación de la matriz de funciones de activación Fx. Los valores de compresión van del 1 al 9 en valores enteros. Al generar la matriz en paralelo poner el índice a 9 no penaliza demasiado, pero tarda el doble que usar el índice 8 y este a la vez tarda el doble que si se usa 7. El índice 6 puede ser una buena elección para discos duros lentos.
